      ...
      <div className={styles['navbar-bg-color']}>
        <Toolbar>
          ...
          <Box sx={{ display: isSearchVisible ? 'none' : { xs: 'none', sm: 'block' } }} className='fadeIn'>
            <Link href='/tags/hoodie' component={NextLink}>
              <Button color={asPath === '/tags/hoodie' ? 'primary' : 'info'}>Hoodie</Button>
            </Link>
            <Link href='/tags/shirt' component={NextLink}>
              <Button color={asPath === '/tags/shirt' ? 'primary' : 'info'}>Shirt</Button>
            </Link>
            <Link href='/tags/hats' component={NextLink}>
              <Button color={asPath === '/tags/hats' ? 'primary' : 'info'}>Hats</Button>
            </Link>
          </Box>
